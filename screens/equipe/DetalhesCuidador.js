...
//------------------------------------Classe---------------------------------------------------//
class DetalhesCuidador extends Component {
    constructor(props) {
        super(props);
        this.state = {
            Nome: '',
            ...
            [
                {
                    text: 'Sim', onPress: () => {
                        ...
                        db.transaction(function (tx) {
                            tx.executeSql(
                                'DELETE FROM CUIDADOR WHERE CODIGO = ?',
                                [Codigo],
                                (tx, results) => {
                                    console.log('Results', results.rowsAffected);
                                    if (results.rowsAffected > 0) {
                ...
                <Header androidStatusBarColor={'black'} style={{ backgroundColor: '#389B87' }}>
                    <Left>
                        <Button icontLeft transparent>
                            ...
                            <Text style={styles.textHeader}>  Alterar Cuidador</Text>
                        </Button>
                    </Left>
                    <Right></Right>
                </Header>
...
export default DetalhesCuidador