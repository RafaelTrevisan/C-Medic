...
class CarregarTreinador extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: []
                ...
                <Header androidStatusBarColor={'black'} style={{ backgroundColor: '#389B87' }}>
                    ...
                    <Right>
                        <Button iconRight transparent>
                            <Text style={styles.iconMenuCabecalho} onPress={() => this.props.navigation.navigate("Treinador")}>Adicionar</Text>
                        </Button>
                    </Right>
                </Header>
                <FlatList
                    ...
                    renderItem={({ item }) => <Treinador navigation = {this.props.navigation} data={item} />}
                />
            </Container>
        );
    }
...
export default CarregarTreinador;